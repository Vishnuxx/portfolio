  ...
  return (
    <div className="relative isolate overflow-hidden px- py-9 sm:py-32 lg:overflow-visible lg:px-0">
      <div className=" mx-auto grid  max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className=" -mt-12 p-12 lg:sticky flex justify-center max-w-[500px] items-center lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <img
